...
(function(){
	...
	app.controller("GameController", function($scope, $interval){
		...
		$scope.loadSong = function(){
			...
			var songDelay = 0;
			var notes = [3,2,4,3,2,1,3,2,4,3,2,1,3,2,4,3,2,1,3,2,4,3,2,1,2,1,3,2,3,4,4,3,4,3,4,2,4,4,2,4,2,4,3,2,3,4,3];
			var noteDelays = [4000, 250, 550, 250, 550, 250, 1000,250, 550, 250, 550, 250, 1000, 250, 550, 250, 550, 250, 1000, 250, 550, 250, 550, 250, 1000, 250, 550, 250, 550, 250, 6300, 110, 110, 110, 110, 110, 210, 210, 210, 110, 210, 210, 210, 210, 110, 110, 110];
